...
Key Idea:
We initialize two pointers, one at the beginning of the string (left) and the other at the end of the string (right). We then compare characters at these two pointers.
If they are both alphanumeric characters and equal in value (ignoring case), we move both pointers towards the center of the string. If they are not equal, we know the string is not a palindrome.
...
# x = Solution()
# y = x.isPalindrome("Was it a car or a cat I saw?")
# print(y)
